...
def plot_dominant_clusters(W_norm, output_filename='NMF_Dogs.png'):
    ...
    plt.xlabel('Dog Samples (Sorted by Dominant Cluster)')
    plt.ylabel('Proportion')
    plt.title('NMF Clustering Proportion of Dogs Dataset')
...
if __name__ == "__main__":
    ...
    plot_dominant_clusters(W_norm, output_filename='NMF_Dogs.png')
